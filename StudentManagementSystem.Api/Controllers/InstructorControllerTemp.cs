...
namespace StudentManagementSystem.Api.Controllers
{
    ...
    public class InstructorControllerTemp : ControllerBase
    {
        private readonly IInstructorServiceTemp _instructorService;
        public InstructorControllerTemp(IInstructorServiceTemp instructorService)
        {
